...
class enqueteAnnuler extends StatelessWidget {
  const enqueteAnnuler({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Enquete Annuler"),
      ),
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Card(
                                    child:
                                    CircleAvatar(
                                      backgroundImage: AssetImage("assets/images/acteursdoser/7.png"),
                                      radius: 25,
                                    ),
                                    elevation: 4,
                                    shape: CircleBorder(),
